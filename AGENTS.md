...
- New integration tests must use the registry-backed environment harness through the temporary integration-new lane and an app-local Vitest fixture. Do not add new legacy per-file fixtures, bespoke Testcontainers orchestration, or direct app-runtime imports for dependency-bearing integration tests.
