import { HandleIntegrationWebhookEventWorkflowSpec } from "@control-plane/workflows";
...
import { createAutomationWebhooksService } from "./automation-webhooks/index.js";
...
export function createAppServices(input: CreateAppServicesInput): AppServices {
  ...
  return {
    ...
    automationWebhooks: createAutomationWebhooksService({
      db: resources.db,
