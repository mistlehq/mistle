...
import { disableOrganizationIdentityLinkProviderConfig } from "../../identity-linking/services/disable-organization-identity-link-provider.js";
...
const routeHandler = async (
  ...
  await disableOrganizationIdentityLinkProviderConfig(
    {
      db,
    },
    {
