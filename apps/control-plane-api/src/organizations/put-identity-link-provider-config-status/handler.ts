...
import { putOrganizationIdentityLinkProviderConfigStatus } from "../../identity-linking/services/put-organization-identity-link-provider-status.js";
...
const routeHandler = async (
  ...
  await putOrganizationIdentityLinkProviderConfigStatus(
    {
      db,
