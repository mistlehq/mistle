...
import { listOrganizationIdentityLinkProviderLinks } from "../../identity-linking/services/list-organization-identity-link-provider-links.js";
...
const routeHandler = async (
  ...
  const links = await listOrganizationIdentityLinkProviderLinks(
    {
      db,
    },
    {
