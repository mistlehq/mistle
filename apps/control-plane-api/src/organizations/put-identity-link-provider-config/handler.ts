...
import { updateOrganizationIdentityLinkProviderConfigConnection } from "../../identity-linking/services/put-organization-identity-link-provider.js";
...
const routeHandler = async (
  ...
  await updateOrganizationIdentityLinkProviderConfigConnection(
    {
      db,
