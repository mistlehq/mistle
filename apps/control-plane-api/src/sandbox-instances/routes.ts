...
import * as createSandboxInstancePublishedPort from "./create-sandbox-instance-published-port/index.js";
...
> {
  ...
  routes.openapi(
    createSandboxInstancePublishedPort.route,
    createSandboxInstancePublishedPort.handler,
  );
