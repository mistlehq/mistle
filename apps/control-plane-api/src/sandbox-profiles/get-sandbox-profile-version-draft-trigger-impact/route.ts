...
export const route = createRoute({
  method: "get",
  path: "/{profileId}/versions/{version}/draft-trigger-impact",
  ...
  responses: {
    200: {
      description:
        "Evaluate whether the specified sandbox profile draft version would break triggers that currently use the profile.",
      content: {
        "application/json": {
          schema: getSandboxProfileVersionDraftTriggerImpactResponseSchema,
        },
      },
    },
    400: {
