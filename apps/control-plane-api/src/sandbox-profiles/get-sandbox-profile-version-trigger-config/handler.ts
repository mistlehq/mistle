...
import { getProfileVersionTriggerConfig } from "../services/get-profile-version-trigger-config.js";
...
const routeHandler = async (
  ...
  const triggerConfig = await getProfileVersionTriggerConfig(
    {
      db,
    },
    {
  ...
  return ctx.json(triggerConfig, 200);
};
