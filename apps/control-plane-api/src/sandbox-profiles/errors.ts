...
export const SandboxProfilesBadRequestCodes = {
  ...
  INVALID_GIT_SIGNING_CONFIG: "INVALID_GIT_SIGNING_CONFIG",
  ...
  INVALID_MISTLE_MCP_CONFIG: "INVALID_MISTLE_MCP_CONFIG",
} as const;
...
export const SandboxProfilesCompileErrorCodes = {
  ...
  AGENT_RUNTIME_CONNECTION_REQUIRED: "AGENT_RUNTIME_CONNECTION_REQUIRED",
...
export const SandboxProfilesConflictCodes = {
  ...
  INVALID_DUPLICATE_REFERENCE: "INVALID_DUPLICATE_REFERENCE",
