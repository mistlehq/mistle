...
import { getProfileVersionAutomationConfig } from "../services/get-profile-version-automation-config.js";
...
const routeHandler = async (
  ...
  const automationConfig = await getProfileVersionAutomationConfig(
    {
      db,
    },
    {
  ...
  return ctx.json(automationConfig, 200);
};
