...
import * as completeProviderAppSetupCallback from "./provider-app-setup/index.js";
...
> {
  ...
  routes.openapi(completeProviderAppSetupCallback.route, completeProviderAppSetupCallback.handler);
  routes.openapi(
