  ...
  return {
    auth: createControlPlaneAuth({
      config: {
        ...
        emailSMTPHost: config.email.smtpHost,
        emailSMTPPort: config.email.smtpPort,
        emailSMTPSecure: config.email.smtpSecure,
        emailSMTPUsername: config.email.smtpUsername,
        emailSMTPPassword: config.email.smtpPassword,
      },
      db: resources.db,
