...
- `github.pull_request.opened`: Pull request opened
  - Template fields: `{{webhookEvent.eventType}}`, `{{payload.repository.full_name}}`, `{{payload.pull_request.number}}`, `{{payload.pull_request.body}}`, `{{payload.pull_request.base.ref}}`, `{{payload.sender.login}}`
...
- `github.pull_request.synchronize`: Pull request updated
  - Template fields: `{{webhookEvent.eventType}}`, `{{payload.repository.full_name}}`, `{{payload.pull_request.number}}`, `{{payload.pull_request.body}}`, `{{payload.pull_request.base.ref}}`, `{{payload.sender.login}}`, `{{payload.pull_request.head.ref}}`
...
- `github.pull_request.review_requested`: Pull request review requested
  - Template fields: `{{webhookEvent.eventType}}`, `{{payload.repository.full_name}}`, `{{payload.pull_request.number}}`, `{{payload.pull_request.body}}`, `{{payload.pull_request.base.ref}}`, `{{payload.sender.login}}`, `{{payload.pull_request.head.ref}}`, `{{payload.requested_reviewer.login}}`, `{{payload.requested_team.slug}}`
