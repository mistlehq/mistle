...
> {
  ...
  routes.use(selectProviderAppSetupInstallation.route.path, requireAuthSession);
  routes.openapi(
    selectProviderAppSetupInstallation.route,
    selectProviderAppSetupInstallation.handler,
  );
  ...
  routes.use(startDeviceAuthorizationReauthorization.route.path, requireAuthSession);
  routes.openapi(
    startDeviceAuthorizationReauthorization.route,
    startDeviceAuthorizationReauthorization.handler,
  );
