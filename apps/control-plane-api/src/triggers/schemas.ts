...
export const TriggerListTargetSchema = z
  .object({
...
export const TriggerListWebhookEventSchema = z
  .object({
...
export const TriggerListWebhookSourceSchema = z
  .object({
    kind: z.literal("webhook"),
    events: z.array(TriggerListWebhookEventSchema),
  })
  .strict();

export const TriggerListScheduleSourceSchema = z
  .object({
