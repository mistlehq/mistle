...
import { createActiveOrganizationRoutes } from "./organizations/index.js";
...
export function registerPublicApiRouteModules(app: ControlPlaneApp): void {
  ...
  const activeOrganizationRoutes = withActiveOrganizationAccess(createActiveOrganizationRoutes());
  ...
  app.route(activeOrganizationRoutes.basePath, activeOrganizationRoutes.routes);
