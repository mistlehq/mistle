...
import { createOAuthWellKnownRoutes } from "./oauth/well-known/index.js";
...
export function registerPublicApiRouteModules(app: ControlPlaneApp): void {
  ...
  const designerRoutes = withOrganizationAccess(createDesignerRoutes());
  ...
  const oauthWellKnownRoutes = createOAuthWellKnownRoutes();
  ...
  app.route(designerRoutes.basePath, designerRoutes.routes);
  ...
  app.route(oauthWellKnownRoutes.basePath, oauthWellKnownRoutes.routes);
