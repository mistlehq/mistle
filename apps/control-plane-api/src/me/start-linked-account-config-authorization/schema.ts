...
export const StartLinkedAccountConfigAuthorizationParamsSchema = z
  .object({
    organizationProviderConfigId: z.string().min(1),
  })
  .strict();

export const StartLinkedAccountConfigAuthorizationBadRequestResponseSchema =
  createCodeMessageErrorSchema(
    z.union([
...
export const StartLinkedAccountConfigAuthorizationNotFoundResponseSchema =
  createCodeMessageErrorSchema(
    z.union([
...
export const StartLinkedAccountConfigAuthorizationValidationErrorResponseSchema =
  ValidationErrorResponseSchema;
