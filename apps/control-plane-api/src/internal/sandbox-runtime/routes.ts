...
import * as resolveDesignerRuntimeEgressRoute from "./resolve-designer-runtime-egress-route/index.js";
...
> {
  ...
  routes.openapi(
    resolveDesignerRuntimeEgressRoute.route,
    resolveDesignerRuntimeEgressRoute.handler,
  );
