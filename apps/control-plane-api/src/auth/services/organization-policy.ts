...
export const OrganizationPermissions = {
  ...
  SANDBOX_SESSION_DELETE: "sandboxSession:delete",
  DESIGNER_SESSION_CREATE: "designerSession:create",
  DESIGNER_SESSION_READ: "designerSession:read",
  DESIGNER_SESSION_UPDATE: "designerSession:update",
  ...
  TRIGGER_WEBHOOK_DELETE: "triggerWebhook:delete",
...
const OWNER_PERMISSIONS: readonly OrganizationPermission[] = [
  ...
  OrganizationPermissions.SANDBOX_SESSION_DELETE,
