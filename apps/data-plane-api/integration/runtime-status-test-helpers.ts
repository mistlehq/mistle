...
function createGatewayEnvironment(input: {
  ...
  const environment: NodeJS.ProcessEnv = {
    ...
    MISTLE_INTERNAL_AUTH_SHARED_TOKEN: input.internalAuthServiceToken,
    MISTLE_SANDBOX_PROVIDER: "docker",
    MISTLE_SANDBOX_DEFAULT_BASE_IMAGE: LocalDevDockerRegistrySandboxBaseImageRef,
    MISTLE_SERVICES_DATA_PLANE_GATEWAY_SANDBOX_WS_PUBLIC_URL: `ws://${host}:${String(input.port)}/tunnel/sandbox`,
    MISTLE_SERVICES_DATA_PLANE_GATEWAY_SANDBOX_WS_INTERNAL_URL: `ws://${host}:${String(input.port)}/tunnel/sandbox`,
    ...
    MISTLE_SANDBOX_TOKENS_CONNECT_AUDIENCE: IntegrationBootstrapTokenAudience,
    MISTLE_SANDBOX_TOKENS_BOOTSTRAP_SECRET: IntegrationBootstrapTokenSecret,
    MISTLE_SANDBOX_TOKENS_BOOTSTRAP_ISSUER: IntegrationBootstrapTokenIssuer,
    MISTLE_SANDBOX_TOKENS_BOOTSTRAP_AUDIENCE: IntegrationBootstrapTokenAudience,
    ...
    MISTLE_SANDBOX_PUBLISH_ACCESS_TOKEN_AUDIENCE: IntegrationBootstrapTokenAudience,
    MISTLE_SANDBOX_PUBLISH_SESSION_COOKIE_SIGNING_SECRET: "integration-publish-cookie-secret",
    MISTLE_SERVICES_DATA_PLANE_GATEWAY_HOST: host,
    MISTLE_SERVICES_DATA_PLANE_GATEWAY_PORT: String(input.port),
    MISTLE_POSTGRES_DATA_PLANE_POOLED_URL: input.databaseUrl,
    MISTLE_KV_DATA_PLANE_BACKEND: "memory",
    MISTLE_SERVICES_DATA_PLANE_API_INTERNAL_URL: input.dataPlaneApiBaseUrl,
    MISTLE_SERVICES_CONTROL_PLANE_API_INTERNAL_URL: input.controlPlaneApiBaseUrl,
    NO_COLOR: "1",
  };
