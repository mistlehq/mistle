...
export type GitHubManualSetupFieldStatus = "idle" | "saving" | "saved" | "saved-fading";

export type GitHubManualSetupFieldState = {
  status: GitHubManualSetupFieldStatus;
  errorMessage: string | null;
};

type GitHubManualSetupFieldBaseProps = {
  id: string;
  label: string;
  value: string;
...
export function GitHubManualSetupField(input: GitHubManualSetupFieldBaseProps): React.JSX.Element {
...
export function GitHubManualSetupSecretField(input: {
  id: string;
  label: string;
  secretLabel: string;
  value: string;
