...
function SlackBugTriageMissingDetailsBlueprintStory(): React.JSX.Element {
  return (
    <DesignerCanvasStoryRuntime>
      <BlueprintCanvasStoryPanel title="Slack bug triage missing-details blueprint">
        <DesignerBlueprintCanvasPanel
...
export const SlackBugTriageMissingDetailsBlueprintLayout: Story = {
  render: function RenderSlackBugTriageMissingDetailsBlueprintStory(): React.JSX.Element {
    return <SlackBugTriageMissingDetailsBlueprintStory />;
  },
};
