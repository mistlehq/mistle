  ...
  return (
    ...
    >
      <div className="bg-card flex flex-col gap-3 rounded-md border p-1.5 shadow-xs">
        ...
        <Textarea
          className="max-h-48 min-h-12 resize-none overflow-y-auto border-0 bg-transparent p-1.5 text-base shadow-none placeholder:text-muted-foreground/60 focus-visible:border-transparent focus-visible:ring-0 md:text-sm"
          id="session-composer"
          onChange={(event) => {
