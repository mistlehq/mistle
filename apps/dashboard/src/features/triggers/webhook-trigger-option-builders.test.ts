...
import type { WebhookTriggerPayloadReference } from "./webhook-trigger-event-types.js";
import {
...
describe("buildWebhookTriggerEventOptions", () => {
...
function buildSlackMessageEventTypes(input: {
  ...
  return buildWebhookTriggerEventOptions({
    connections: [
      {
