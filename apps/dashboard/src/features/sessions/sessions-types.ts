...
type ListSandboxOperationEventsResponse =
  paths["/v1/sandbox/instances/{instanceId}/operation-events"]["get"]["responses"][200]["content"]["application/json"];
...
export type SandboxOperationEventsResult = ListSandboxOperationEventsResponse;
export type SandboxOperationEvent = SandboxOperationEventsResult["events"][number];
