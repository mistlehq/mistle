...
export function AutomationStatusDot(input: { enabled: boolean }): React.JSX.Element {
  return (
    <>
      <span
        aria-hidden
...
export function AutomationIssueIndicator(input: {
  issue: AutomationIssue | undefined;
  enabled: boolean;
}): React.JSX.Element {
