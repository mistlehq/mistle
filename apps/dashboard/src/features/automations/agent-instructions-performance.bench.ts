...
function createSyntheticEventOption(index: number): WebhookAutomationEventOption {
...
function createSyntheticEventOptions(count: number): readonly WebhookAutomationEventOption[] {
