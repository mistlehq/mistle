...
import { GoogleWorkspaceServiceAccountCredentialResolver } from "./service-account-credential-resolver.server.js";
...
export const GoogleWorkspaceDefinition: GoogleWorkspaceMcpBaseIntegrationDefinition = {
  ...
  credentialResolvers: {
    default: GoogleWorkspaceServiceAccountCredentialResolver,
  },
};
