...
import { PlanetScaleBaseDefinition } from "./planetscale/variants/planetscale-default/base-definition.js";
...
export const PlanetScaleBrowserDefinition = PlanetScaleBaseDefinition;
