...
const fieldOrientationHorizontalClasses =
  "md:flex-row md:items-start md:gap-4 md:[&>[data-slot=field-label],&>[data-slot=field-header]]:w-40 md:[&>[data-slot=field-label],&>[data-slot=field-header]]:shrink-0 md:[&>[data-slot=field-label]]:self-center md:[&>[data-slot=field-header]:not(:has([data-slot=field-description]))]:self-center md:[&>[data-slot=field-header]:has([data-slot=field-description])]:pt-2 md:has-[>[data-slot=field-content]>[data-slot=checkbox-group]]:[&>[data-slot=field-label],&>[data-slot=field-header]]:pt-0 md:[&>[data-slot=field-content]]:min-w-0 md:[&>[data-slot=field-label]]:pt-1 md:[&>[data-slot=field-header]>[data-slot=field-label]]:pt-1 md:[&>[data-slot=field-header]>[data-slot=field-label-with-tooltip]]:pt-1 md:[&_[data-slot=select-trigger]]:w-fit md:has-[>[role=checkbox]+[data-slot=field-content]]:items-center md:has-[>[role=radio]+[data-slot=field-content]]:items-center md:has-[>[role=switch]+[data-slot=field-content]]:items-center md:has-[>[role=checkbox]+[data-slot=field-content]]:[&>[role=checkbox]]:mt-px md:has-[>[role=radio]+[data-slot=field-content]]:[&>[role=radio]]:mt-px md:has-[>[role=switch]+[data-slot=field-content]]:[&>[role=switch]]:mt-px";
...
function FieldLabelWithTooltip({
  ...
  return (
    <div className="flex items-center gap-1.5" data-slot="field-label-with-tooltip">
