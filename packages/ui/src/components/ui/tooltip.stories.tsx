...
const WrappedPayloadText =
  '{"event":"session.bootstrap","payload":{"requestId":"req_01JSW2S6YVB4TQ2GJ1F9V2A6M3","workspaceId":"ws_01JSW2S6YVB4TQ2GJ1F9V2A6M3","profile":"repo-maintainer","files":["apps/dashboard/src/features/navigation/sessions-sidebar-nav.tsx","apps/dashboard/src/features/navigation/sessions-sidebar-nav.test.tsx"],"message":"This payload should wrap cleanly inside the tooltip without requiring internal scrolling."},"metadata":{"trace":"trace_01JSW2S6YVB4TQ2GJ1F9V2A6M3","span":"span_01JSW2S6YVB4TQ2GJ1F9V2A6M3","user":"jonathan.low@example.com"}}';
