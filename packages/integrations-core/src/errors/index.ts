...
export const WebhookErrorCodes: {
  ...
  WEBHOOK_SOURCE_ORDER_KEY_MISSING: WebhookErrorCode;
} = {
  WEBHOOK_HANDLER_NOT_CONFIGURED: "WEBHOOK_HANDLER_NOT_CONFIGURED",
  WEBHOOK_REQUEST_INVALID: "WEBHOOK_REQUEST_INVALID",
  ...
  WEBHOOK_SOURCE_ORDER_KEY_MISSING: "WEBHOOK_SOURCE_ORDER_KEY_MISSING",
};
