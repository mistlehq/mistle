...
export function createDefaultTelemetryEnvironment(): Record<string, string> {
  return {
    MISTLE_TELEMETRY_ENABLED: process.env.MISTLE_TELEMETRY_ENABLED ?? "true",
    MISTLE_TELEMETRY_DEBUG: process.env.MISTLE_TELEMETRY_DEBUG ?? "false",
    MISTLE_TELEMETRY_TRACES_ENDPOINT:
      process.env.MISTLE_TELEMETRY_TRACES_ENDPOINT ?? DEFAULT_DOCKER_TEST_OTLP_TRACES_ENDPOINT,
    MISTLE_TELEMETRY_LOGS_ENDPOINT:
      process.env.MISTLE_TELEMETRY_LOGS_ENDPOINT ?? DEFAULT_DOCKER_TEST_OTLP_LOGS_ENDPOINT,
    MISTLE_TELEMETRY_METRICS_ENDPOINT:
      process.env.MISTLE_TELEMETRY_METRICS_ENDPOINT ?? DEFAULT_DOCKER_TEST_OTLP_METRICS_ENDPOINT,
    MISTLE_TELEMETRY_RESOURCE_ATTRIBUTES:
      process.env.MISTLE_TELEMETRY_RESOURCE_ATTRIBUTES ?? DEFAULT_DOCKER_TEST_RESOURCE_ATTRIBUTES,
  };
}
