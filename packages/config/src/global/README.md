...
| `sandbox.storage.backend`         | `"archil" \| "docker_volume"`   | Durable storage backend configured for sandbox persistence.   | None    | `[global.sandbox.storage].backend`          | `MISTLE_GLOBAL_SANDBOX_STORAGE_BACKEND`          |
