...
| `sandbox.gatewayWsUrl`            | `string`                        | Shared gateway WebSocket base URL for sandbox connections.  | None    | `[global.sandbox].gateway_ws_url`           | `MISTLE_GLOBAL_SANDBOX_GATEWAY_WS_URL`           |
