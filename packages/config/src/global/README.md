...
| `sandbox.storage.backend`         | `"none" \| "archil"`            | Durable sandbox storage backend enabled for the deployment.   | None    | `[global.sandbox.storage].backend`          | `MISTLE_GLOBAL_SANDBOX_STORAGE_BACKEND`          |
