...
| `controlPlaneApi.baseUrl`     | `string`              | Internal control-plane API base URL used for storage mode resolution.     | None      | `[apps.data_plane_api.control_plane_api].base_url`     | `MISTLE_APPS_DATA_PLANE_API_CONTROL_PLANE_API_BASE_URL`     |
