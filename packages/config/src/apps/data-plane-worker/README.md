...
| `workflow.databaseUrl`                   | `string`            | Postgres URL used by OpenWorkflow backend in data-plane.           | None      | `MISTLE_POSTGRES_DATA_PLANE_POOLED_URL`                                                                       |
...
| `sandbox.tokenizerProxyEgressBaseUrl`    | `string`            | Base URL used for sandbox-runtime tokenizer proxy egress hops.     | None      | `MISTLE_SERVICES_TOKENIZER_PROXY_EGRESS_URL`                                                                  |
...
| `sandbox.e2b.apiKey`                     | `string`            | E2B API key used when provider is e2b.                             | None      | `MISTLE_SANDBOX_E2B_API_KEY`                                                                                  |
| `sandbox.e2b.domain`                     | `string` (optional) | Optional E2B domain override.                                      | `e2b.app` | `MISTLE_SANDBOX_E2B_DOMAIN`                                                                                   |
| `sandbox.e2b.cpuCount`                   | `number` (`>=1`)    | Optional E2B template CPU default used for new sandboxes.          | `2`       | `MISTLE_SANDBOX_E2B_CPU_COUNT`                                                                                |
| `sandbox.e2b.memoryMb`                   | `number` (`>=1`)    | Optional E2B template memory default in MB for new sandboxes.      | `4096`    | `MISTLE_SANDBOX_E2B_MEMORY_MB`                                                                                |
