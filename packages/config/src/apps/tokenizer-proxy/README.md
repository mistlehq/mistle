...
| `controlPlaneApi.publicBaseUrl` | `string` (URL)        | Public base URL for control-plane session-link redirects.        | None    | `[apps.tokenizer_proxy.control_plane_api].public_base_url` | `MISTLE_APPS_TOKENIZER_PROXY_CONTROL_PLANE_API_PUBLIC_BASE_URL` |
