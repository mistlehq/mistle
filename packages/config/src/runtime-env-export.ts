...
const ControlPlaneApiResourceRuntimeEnvExports: readonly RuntimeEnvExportDescriptor[] = [
  ...
  { path: ["sandbox", "freestyle", "enabled"], envVar: "MISTLE_SANDBOX_FREESTYLE_ENABLED" },
  { path: ["sandbox", "freestyle", "apiKey"], envVar: "MISTLE_SANDBOX_FREESTYLE_API_KEY" },
  { path: ["sandbox", "freestyle", "baseUrl"], envVar: "MISTLE_SANDBOX_FREESTYLE_BASE_URL" },
