...
const RootEnvDescriptors = [
  ...
  },
  {
    ...
    path: ["services", "control_plane_api", "auth", "welcome_email", "enabled"],
    parse: parseBooleanEnv,
  },
  {
    envVar: "MISTLE_SERVICES_CONTROL_PLANE_API_AUTH_WELCOME_EMAIL_CALL_URL",
    path: ["services", "control_plane_api", "auth", "welcome_email", "call_url"],
  },
  {
  ...
  },
  {
    ...
    path: ["services", "control_plane_api", "auth", "github", "client_id"],
  },
  {
    envVar: "MISTLE_SERVICES_CONTROL_PLANE_API_AUTH_GITHUB_CLIENT_SECRET",
    path: ["services", "control_plane_api", "auth", "github", "client_secret"],
  },
  {
  ...
  },
  {
    ...
    path: ["services", "control_plane_api", "mcp", "auth", "issuer"],
  },
  {
    envVar: "MISTLE_SERVICES_CONTROL_PLANE_API_MCP_AUTH_AUDIENCE",
    path: ["services", "control_plane_api", "mcp", "auth", "audience"],
  },
  {
  ...
  {
    envVar: "MISTLE_SANDBOX_FREESTYLE_API_KEY",
    path: ["sandbox", "freestyle", "api_key"],
  },
  {
    envVar: "MISTLE_SANDBOX_FREESTYLE_BASE_URL",
    path: ["sandbox", "freestyle", "base_url"],
  },
  {
