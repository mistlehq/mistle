...
export const configEnvTomlMappings: readonly ConfigEnvTomlMapping[] = [
  ...
  {
    configPath: ["apps", "control_plane_api", "integrations", "targetCatalog", "github", "appSlug"],
    tomlPath: ["apps", "control_plane_api", "integrations", "target_catalog", "github", "app_slug"],
    envVar: "MISTLE_APPS_CONTROL_PLANE_API_INTEGRATIONS_GITHUB_APP_SLUG",
  },
  {
    configPath: ["apps", "control_plane_api", "integrations", "targetCatalog", "github", "appId"],
    tomlPath: ["apps", "control_plane_api", "integrations", "target_catalog", "github", "app_id"],
    envVar: "MISTLE_APPS_CONTROL_PLANE_API_INTEGRATIONS_GITHUB_APP_ID",
  },
  {
    configPath: [
      "apps",
    ...
    envVar: "MISTLE_APPS_CONTROL_PLANE_API_INTEGRATIONS_GITHUB_CLIENT_ID",
  },
  {
    configPath: [
      "apps",
    ...
    envVar: "MISTLE_APPS_CONTROL_PLANE_API_INTEGRATIONS_GITHUB_API_BASE_URL",
  },
  {
    configPath: [
      "apps",
    ...
    envVar: "MISTLE_APPS_CONTROL_PLANE_API_INTEGRATIONS_GITHUB_WEB_BASE_URL",
  },
  {
    configPath: [
      "apps",
    ...
    envVar: "MISTLE_APPS_CONTROL_PLANE_API_INTEGRATIONS_OPENAI_API_BASE_URL",
  },
  {
    configPath: [
      "apps",
    ...
    envVar: "MISTLE_APPS_CONTROL_PLANE_API_INTEGRATIONS_GITHUB_ENTERPRISE_APP_SLUG",
  },
  {
    configPath: [
      "apps",
    ...
    envVar: "MISTLE_APPS_CONTROL_PLANE_API_INTEGRATIONS_GITHUB_ENTERPRISE_APP_ID",
  },
  {
    configPath: [
      "apps",
    ...
    envVar: "MISTLE_APPS_CONTROL_PLANE_API_INTEGRATIONS_GITHUB_ENTERPRISE_CLIENT_ID",
  },
  {
    configPath: [
      "apps",
    ...
    envVar: "MISTLE_APPS_CONTROL_PLANE_API_INTEGRATIONS_GITHUB_ENTERPRISE_API_BASE_URL",
  },
  {
    configPath: [
      "apps",
    ...
    envVar: "MISTLE_APPS_CONTROL_PLANE_API_INTEGRATIONS_GITHUB_ENTERPRISE_WEB_BASE_URL",
  },
  {
