...
const baseIntegrationEnv: NodeJS.ProcessEnv = {
  ...
  MISTLE_GLOBAL_SANDBOX_PUBLISH_ACCESS_TOKEN_SECRET: "fixture-publish-token-secret",
  ...
  MISTLE_APPS_CONTROL_PLANE_API_DATABASE_URL: "postgresql://mistle:mistle@127.0.0.1:6432/mistle",
  ...
  MISTLE_APPS_DATA_PLANE_API_DATABASE_URL: "postgresql://mistle:mistle@127.0.0.1:6432/mistle",
  ...
  MISTLE_APPS_DATA_PLANE_API_CONTROL_PLANE_API_BASE_URL: "http://127.0.0.1:5000",
  ...
  MISTLE_APPS_DATA_PLANE_GATEWAY_DATABASE_URL: "postgresql://mistle:mistle@127.0.0.1:6432/mistle",
  ...
  MISTLE_APPS_DATA_PLANE_GATEWAY_CONTROL_PLANE_API_BASE_URL: "http://127.0.0.1:5000",
  MISTLE_APPS_DATA_PLANE_WORKER_DATABASE_URL: "postgresql://mistle:mistle@127.0.0.1:6432/mistle",
  ...
  MISTLE_APPS_DATA_PLANE_WORKER_CONTROL_PLANE_API_BASE_URL: "http://127.0.0.1:5000",
  ...
  MISTLE_APPS_DATA_PLANE_WORKER_SANDBOX_STORAGE_ARCHIL_API_KEY: "fixture-archil-api-key",
  ...
  MISTLE_APPS_DATA_PLANE_WORKER_SANDBOX_STORAGE_ARCHIL_MOUNTS_JSON:
    '[{"type":"s3-compatible","bucket":"mistle-sandbox-storage","endpoint":"https://s3.example.com","accessKeyId":"fixture-access-key-id","secretAccessKey":"fixture-secret-access-key"}]',
  ...
  MISTLE_APPS_TOKENIZER_PROXY_CONTROL_PLANE_API_PUBLIC_BASE_URL: "http://127.0.0.1:5000",
};
