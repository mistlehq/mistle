...
export function defineIntegrationConnectionResources(schema: PgSchema) {
  return schema.table(
...
export const integrationConnectionResources =
  defineIntegrationConnectionResources(controlPlaneSchema);
