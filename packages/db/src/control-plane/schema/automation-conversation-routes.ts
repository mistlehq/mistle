...
export function defineAutomationConversationRoutes(schema: PgSchema) {
  return schema.table(
...
export const automationConversationRoutes = defineAutomationConversationRoutes(controlPlaneSchema);
