...
export function defineIntegrationConnectionDeviceAuthorizationAttempts(schema: PgSchema) {
  return schema.table(
...
export const integrationConnectionDeviceAuthorizationAttempts =
  defineIntegrationConnectionDeviceAuthorizationAttempts(controlPlaneSchema);
