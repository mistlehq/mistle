import { bigint, index, primaryKey, text, timestamp, type PgSchema } from "drizzle-orm/pg-core";
...
export function defineIntegrationConnectionResourceStates(schema: PgSchema) {
  return schema.table(
...
export const integrationConnectionResourceStates =
  defineIntegrationConnectionResourceStates(controlPlaneSchema);
