import { bigint, foreignKey, index, text, timestamp, type PgSchema } from "drizzle-orm/pg-core";
...
export function defineSandboxProfileSnapshotRefreshScheduleTargets(schema: PgSchema) {
  return schema.table(
...
export const sandboxProfileSnapshotRefreshScheduleTargets =
  defineSandboxProfileSnapshotRefreshScheduleTargets(controlPlaneSchema);
