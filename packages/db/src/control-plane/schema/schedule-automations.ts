import { text, timestamp, type PgSchema } from "drizzle-orm/pg-core";

import { automations } from "./automations.js";
import { controlPlaneSchema } from "./namespace.js";
import { schedules } from "./schedules.js";

export function defineScheduleAutomations(schema: PgSchema) {
  return schema.table("schedule_automations", {
...
export const scheduleAutomations = defineScheduleAutomations(controlPlaneSchema);
