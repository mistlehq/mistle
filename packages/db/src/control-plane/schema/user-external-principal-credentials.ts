...
export function defineUserExternalPrincipalCredentials(schema: PgSchema) {
  return schema.table(
...
export const userExternalPrincipalCredentials =
  defineUserExternalPrincipalCredentials(controlPlaneSchema);
