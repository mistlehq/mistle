...
export function defineUserExternalPrincipalKeys(schema: PgSchema) {
  return schema.table(
...
export const userExternalPrincipalKeys = defineUserExternalPrincipalKeys(controlPlaneSchema);
