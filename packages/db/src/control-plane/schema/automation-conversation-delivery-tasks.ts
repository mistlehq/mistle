...
export function defineAutomationConversationDeliveryTasks(schema: PgSchema) {
  return schema.table(
...
export const automationConversationDeliveryTasks =
  defineAutomationConversationDeliveryTasks(controlPlaneSchema);
