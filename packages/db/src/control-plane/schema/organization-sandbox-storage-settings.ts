import { bigint, boolean, text, timestamp, uniqueIndex, type PgSchema } from "drizzle-orm/pg-core";
...
export function defineOrganizationSandboxStorageSettings(schema: PgSchema) {
  return schema.table(
...
export const organizationSandboxStorageSettings =
  defineOrganizationSandboxStorageSettings(controlPlaneSchema);
