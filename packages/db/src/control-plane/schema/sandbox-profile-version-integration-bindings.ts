...
export function defineSandboxProfileVersionIntegrationBindings(schema: PgSchema) {
  return schema.table(
...
export const sandboxProfileVersionIntegrationBindings =
  defineSandboxProfileVersionIntegrationBindings(controlPlaneSchema);
