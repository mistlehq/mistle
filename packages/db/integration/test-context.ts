...
function readSharedInfraConfig(): SharedInfraConfig {
  return {
    databaseUsername: requireEnv("MISTLE_DB_IT_DB_USER"),
    databasePassword: requireEnv("MISTLE_DB_IT_DB_PASSWORD"),
    databaseDirectHost: requireEnv("MISTLE_DB_IT_DB_DIRECT_HOST"),
    databaseDirectPort: parsePort({
      value: requireEnv("MISTLE_DB_IT_DB_DIRECT_PORT"),
      variableName: "MISTLE_DB_IT_DB_DIRECT_PORT",
    }),
    templateDatabaseName: requireEnv("MISTLE_DB_IT_TEMPLATE_DB_NAME"),
  };
}
