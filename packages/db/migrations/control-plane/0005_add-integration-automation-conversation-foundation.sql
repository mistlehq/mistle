...
ALTER TABLE "control_plane"."automation_conversation_routes" ADD CONSTRAINT "automation_conversation_routes_conversation_id_automation_conversations_id_fk" FOREIGN KEY ("conversation_id") REFERENCES "control_plane"."automation_conversations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
