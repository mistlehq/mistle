...
ALTER INDEX "control_plane"."webhook_automations_integration_connection_id_idx" RENAME TO "webhook_automations_integration_webhook_source_id_idx";--> statement-breakpoint
