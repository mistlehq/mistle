...
//! websocket streams, direct PTY control, and file uploads.
...
use crate::tunnel::session::bootstrap::{
    ...
    spawn_tunnel_wake_thread, startup_transparent_passthrough_socket_mark, write_tunnel_close,
    write_tunnel_pong, write_tunnel_text,
};
...
mod tests {
    use super::{
        ...
        prioritize_ipv4_socket_addresses, record_egress_token_event,
    ...
    async fn file_search_stream_returns_results_from_open_cwd() {
        ...
        handle_tunnel_control_message(
            &tunnel_writer_sender,
            &event_sender,
            parse_stream_control_message(&open_payload)
    ...
    fn file_search_query_telemetry_fields_include_latency_and_limit_signals() {
        let fields = super::file_search_query_telemetry_fields(
            31,
            "file_search_req_1",
