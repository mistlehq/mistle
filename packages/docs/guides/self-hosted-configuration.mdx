...
by the current runtime. Add `google` or `github` only when the matching OAuth
...
blocking first-time OTP, Google, and GitHub users from creating accounts.
...
| `services.control_plane_api.auth.enabled_methods`                              | No                                         | Supported values: `otp`, `google`, `github`. Social providers require credentials. If omitted, only OTP is exposed to users. |
| `services.control_plane_api.auth.allow_signups`                                | No                                         | Whether first-time OTP, Google, and GitHub sign-ins may create users. Defaults to `true`.                                    |
...
| `services.control_plane_api.auth.github.client_id`                             | Required when GitHub auth is enabled       | GitHub OAuth app client ID.                                                                                                  |
| `services.control_plane_api.auth.github.client_secret`                         | Required when GitHub auth is enabled       | GitHub OAuth app client secret.                                                                                              |
