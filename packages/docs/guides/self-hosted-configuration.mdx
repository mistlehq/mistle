...
| `services.tokenizer_proxy`      | `host`, `port`, `egress_url`                           |
...
| `services.tokenizer_proxy.public_url`                                          | No                                         | Public tokenizer proxy URL.                                                                               |
| `services.tokenizer_proxy.internal_url`                                        | No                                         | Internal tokenizer proxy URL.                                                                             |
