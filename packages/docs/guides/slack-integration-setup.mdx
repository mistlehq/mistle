...
| Scope               | Enables                                               |
| ------------------- | ----------------------------------------------------- |
| `app_mentions:read` | Receive `app_mention` events for Slack triggers       |
| `channels:history`  | Receive public channel messages for Slack triggers    |
| `channels:read`     | Sync public channels as selectable trigger resources  |
| `files:read`        | Read and download files shared with the app           |
| `files:write`       | Upload files as the app                               |
| `groups:history`    | Receive private channel messages for Slack triggers   |
| `groups:read`       | Sync private channels as selectable trigger resources |
| `usergroups:read`   | Sync user groups as selectable trigger resources      |
| `users:read`        | Sync users as selectable trigger resources            |
...
| Event               | Enables                                       |
| ------------------- | --------------------------------------------- |
| `app_mention`       | Slack trigger source                          |
...
| `message.channels`  | Slack message triggers in public channels     |
| `message.groups`    | Slack message triggers in private channels    |
| `subteam_created`   | Refresh synced user groups when created       |
| `subteam_updated`   | Refresh synced user groups when updated       |
| `team_join`         | Refresh synced users when a member joins      |
| `user_change`       | Refresh synced users when member data changes |
...
- [team_join event](https://docs.slack.dev/reference/events/team_join)
- [user_change event](https://docs.slack.dev/reference/events/user_change)
- [subteam_created event](https://docs.slack.dev/reference/events/subteam_created)
- [subteam_updated event](https://docs.slack.dev/reference/events/subteam_updated)
...
- [usergroups.list](https://docs.slack.dev/reference/methods/usergroups.list/)
