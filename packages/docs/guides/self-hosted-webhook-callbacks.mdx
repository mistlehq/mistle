...
In this repository's local compose workflow, `./up.sh` starts a Cloudflare quick tunnel when needed. Use that printed public control-plane URL when configuring provider apps and webhook registrations.
