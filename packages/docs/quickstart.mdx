...
Publishing makes the profile version available for new sessions and queues snapshot creation. The snapshot prepares the sandbox image by applying the published runtime plan and setup script.
