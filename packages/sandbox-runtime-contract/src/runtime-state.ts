...
export const SandboxRuntimeSummarySchema = z
  .object({
    ready: z.boolean(),
  })
  .strict();
...
export const SandboxRuntimeStateSnapshotSchema = z
  .object({
    ...
    runtime: SandboxRuntimeSummarySchema,
  })
  .strict();
...
export type SandboxRuntimeSummary = z.infer<typeof SandboxRuntimeSummarySchema>;
