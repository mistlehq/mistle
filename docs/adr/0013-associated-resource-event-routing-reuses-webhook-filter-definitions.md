...
Webhook parameter metadata such as multi-value resource selection carries through to projected association event filters unless the projection explicitly omits or overrides that parameter.
